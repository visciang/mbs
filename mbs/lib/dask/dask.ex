defmodule Dask do
  ...
  @spec job(M.t(), Job.id(), Job.fun(), timeout()) :: M.t()
  def job(%M{} = workflow, job_id, job_fun, job_timeout \\ :infinity) do
    j = %Job{id: job_id, fun: job_fun, timeout: job_timeout, downstream_jobs: MapSet.new()}
